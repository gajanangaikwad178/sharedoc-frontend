...
/*
Template Name: Sandbox - Admin & Dashboard Template
Author: CoderThemes
Version: 1.0.0
    ...
    */
    ...
    App.prototype.init = function () {
        ...
        if (window.sessionStorage && bodyConfig && bodyConfig.hasOwnProperty('showRightSidebarOnPageLoad') && bodyConfig['showRightSidebarOnPageLoad']) {
            var alreadyVisited = sessionStorage.getItem("_Sandbox_VISITED_");
            if (!alreadyVisited) {
                $.RightBar.toggleRightSideBar();
                sessionStorage.setItem("_Sandbox_VISITED_", true);
            }
        }
